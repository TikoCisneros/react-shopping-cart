 ...
 */
export function countObjectKeys(obj: Record<string | number, unknown>): number {
 ...
 */
export function hasKeyInObject(obj: Record<string | number, unknown>, key: string | number): boolean {
